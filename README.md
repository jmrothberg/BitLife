...
Full system-by-system table (v0.26.0). Counts + the gap-closure roadmap live in **[AGENTS.md](./AGENTS.md)** (the contributor/LLM guide).
...
| School & education | Daycare → uni / grad / med / law; majors, GPA, clubs, sports, class president, loans, scholarships, dropout | Auto K-12 + college, 12 degrees + **grades & popularity stats**, joinable **clubs / sports teams / cliques** (per-stage, requirement-gated), **school dances**, **class president**, **dropout**, **merit scholarships**, honors ribbons | ✅ |
...
| Royalty | Born/marry in, rule, throne, scandals, exile | **Born royal** or **marry into royalty** → ascend the throne; **rule** (raise/cut taxes, festivals, wage war, name an heir, abdicate) with **approval & treasury**; overthrow/exile; **dynastic succession** | ✅ |
...
| Achievements / ribbons | Large set + end-of-life summary | 40 ribbons + death summary | 🟡 |
...
---
*v0.26.0 — Jonathan Rothberg, 2026. An homage to BitLife by Candywriter, LLC; not affiliated with or
